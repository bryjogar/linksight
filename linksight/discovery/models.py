...
class Hop:
    ...
    status: str = "ok"  # "ok", "timeout", "unreachable", "auth_failed", "root_reached", "router_reached"
...
class UpstreamPath:
    ...
    edge_type: str = "unknown"  # "stp_root", "router", "firewall", "gateway", "timeout", "unreachable"
    edge_summary: str = ""

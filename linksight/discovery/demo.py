...
# Aruba switch MIB fixture with Mesh Uplink Candidate on Port 24 and UniFi Candidate on Port 47
...
def get_aruba_demo_path(
    ...
    if (
        ...
        hop3 = Hop(
            ...
            hostname="Eero-Mesh",
            mgmt_ip="192.168.1.1",
            sys_descr="Eero Pro 6 Gateway, eeroOS 6.16.0",
            platform="Eero Pro 6",
            device_type="gateway",
            is_stp_root=False,
            status="router_reached",
        ...
        return UpstreamPath(
            start_ip=start_ip,
            hops=[hop1_continued, hop2, hop3],
            edge_type="gateway",
            edge_summary="Edge gateway reached: Eero-Mesh (192.168.1.1) — WAN WAN via ISP gateway 203.0.113.1",
            success=True,
        )
